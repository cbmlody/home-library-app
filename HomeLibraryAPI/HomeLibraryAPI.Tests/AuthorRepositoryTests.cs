...
namespace Repository.Tests
{
    ...
    {
        [Fact]
        public void FindAll_ThreeObjectsStored_CollectionsAreEqual()
        {
            // Arrange
            ...
            var authors = testAuthors.Generate(numberOfAuthors);
        ...
        [Fact]
        public void FindAllByCondition_OneObjectStored_CollectionsAreEqual()
        {
            // Arrange
